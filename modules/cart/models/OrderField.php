...
/**
 * This is the model class for table "{{orders_fields}}".
 *
 * The followings are the available columns in table '{{orders_fields}}':
 * @property integer $id
 ...
 */
class OrderField extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return OrderField the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('varname, title, field_type, match, range, error_message, other_validator, default', 'required'),
